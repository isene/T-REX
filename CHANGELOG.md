...
### Fixed
- Fix stack corruption during number entry terminated by ENTER or operator keys
- ENTER after number entry now correctly duplicates X into Y (was dropping instead of lifting)
- Operator keys after number entry no longer incorrectly drop Y before executing
